...
class RestauraunOrderManagement:
    def __init__(self,root):
        self.root=root
        self.root.title=("Restauraunt Management App")
        self.menu_items={
            "FRIES MEAL": 2,
            "LUNCH MEAL": 2,
            "BURGER MEAL": 3,
        ...
        ttk.Label(frame,
                  text="Restauraun Order Management",
    ...
    def update_menu_prices(self,*args):
        ...
        rate=self.exchange_rate if self.currency=="INR" else 1
...
if __name__=="__main__":
    root=tk.Tk()
    app=RestauraunOrderManagement(root)
